...
export function getDefLocations() {
  ...
  return {
    Player: {
      ...
      path: path.resolve(__dirname, 'schema/query.gql'),
    },
    Player_id: {
    ...
    Mutation: {
      ...
      path: path.resolve(__dirname, 'schema/mutation.gql'),
    },
    ...
    Role: {
      ...
      path: path.resolve(__dirname, 'schema/enums.gql'),
    },

    CustomScalar: {
      start: { line: 1, column: 1 },
      end: { line: 1, column: 20 },
      path: path.resolve(__dirname, 'schema/scalars.gql'),
    },

    customDirective: {
      start: { line: 2, column: 1 },
      end: { line: 7, column: 25 },
      path: path.resolve(__dirname, 'schema/directives.gql'),
    },
