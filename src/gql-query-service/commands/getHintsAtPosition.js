...
import { type GQLPosition, type GQLHint, type IParser } from 'gql-shared/types';
import {
  typeName,
  GQLEnumType,
  getNamedType,
...
export default function getHintsAtPosition({
  ...
  if (kind === 'Directive') {
    const directives = schema
      .getDirectives()
      .filter(directive => canUseDirective(state.prevState.kind, directive));
